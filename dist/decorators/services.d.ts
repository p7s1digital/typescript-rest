 ...
 * ```
 */
export declare function PreProcessor(preprocessor: ServicePreProcessor): (...args: any[]) => void;
/**
 * A decorator to tell the [[Server]] that a class or a method
 ...
 * ```
 */
export declare function PostProcessor(postprocessor: ServicePostProcessor): (...args: any[]) => void;
/**
 * A decorator to tell the [[Server]] that a class or a method

...
export declare type ServicePreProcessor = (req: express.Request, res?: express.Response) => void;
export declare type ServicePostProcessor = (req: express.Request, res?: express.Response, result?: any) => void;
